...
## Phase 2: Refinement & Video (Optional/Later)
- [ ] Task: Add caption support (if not covered in Phase 1)
- [ ] Task: Add robust error handling for upload failures (timeouts, file type errors)
